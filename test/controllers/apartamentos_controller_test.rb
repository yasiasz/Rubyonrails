...
class ApartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartamento" do
    assert_difference('Apartamento.count') do
      post apartamentos_url, params: { apartamento: { numero: @apartamento.numero, piso: @apartamento.piso, torre_id: @apartamento.torre_id } }
    end
  ...
  test "should update apartamento" do
    patch apartamento_url(@apartamento), params: { apartamento: { numero: @apartamento.numero, piso: @apartamento.piso, torre_id: @apartamento.torre_id } }
